...
for pr in prs:
    ...
    info_raw = run(f"gh pr view {num} --repo {repo} --json reviewDecision,reviews,mergeable,mergeStateStatus,reviewRequests,statusCheckRollup")
    ...
    results.append({
        ...
        'pending_reviewers': pending_reviewers, 'ci': ci,
    })
